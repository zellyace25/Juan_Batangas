...
function HELPPrograms() {
  ...
  return (
    <div className="border flex flex-col gap-8 bg-[#F5F5F5]">
        <h1 className="gradient-text font-bold text-[60px]">
          H-E-L-P PROGRAM
        </h1>
       <div className="flex relative border border-green-400">
          <div className="w-full">
            {/* for icons */}
            <div className=" absolute flex border border-blue-500 w-full justify-evenly">
            ...
            {/* for info */}
            <div className=" bg-white mt-10">heheeh</div>
          </div>
       </div>
    </div>
  );
