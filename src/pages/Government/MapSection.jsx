...
const MapSection = () => {
  ...
  const [long, setLong] = useState(13.755872)
  const [lang, setLang] = useState(121.058476)
  ...
  return (
    <div className=' px-[5rem] pt-[10rem]' style={{background: `url(${paperImg})`, backgroundColor:'rgb(245 245 245)', backgroundSize:'cover'}}>
        <div className=' bg-white rounded-[50px] p-12'>
            <MapContext.Provider value={{ setData, setMap, setLong, setLang}}>
                <div className=' flex border border-purple-400 w-full gap-8'>
