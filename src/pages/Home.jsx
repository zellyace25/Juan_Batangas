    ...
    <>
      ...
      <div className="bg-[#F5F5F5] w-full h-full flex flex-col gap-10">
        ...
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-[#4D4D4D] font-semibold text-[30px]">
            PRO-COMBAT
          </h1>
          ...
          <div className="absolute w-full h-full p-20 flex flex-col justify-center items-center gap-10">
            ...
            <div className="w-full  items-center flex justify-center">
              ...
              >
                ...
                <div className="white-button-prev text-white"></div>

                <div className="white-button-next text-white"></div>
              </Swiper>
            </div>
          </div>
        </div>
        <div className="flex justify-between w-full h-[400px] items-center">
          <div className="w-1/2 px-20">
            ...
            <h1 className="text-[36px] w-auto">News and Announcement about</h1>
            <h1 className="font-semibold text-[36px] w-auto">Batangas</h1>
            <p>
